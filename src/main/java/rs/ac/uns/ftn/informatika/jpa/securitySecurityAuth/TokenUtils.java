package rs.ac.uns.ftn.informatika.jpa.securitySecurityAuth;
...
public String generateToken(String username,ArrayList<String> list) {
    String auto="";
    if(list.size()==1){
        auto=list.get(0);
    }else{
    ...
    return Jwts.builder()
           ...
           // .setPayload(auto)
            ...
            .claim("key", auto) //moguce je postavljanje proizvoljnih podataka u telo JWT tokena
